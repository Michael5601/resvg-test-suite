...
with open('chart_w3c.json', 'w') as f:
...
with open('group_results_w3c.json', 'w') as f:
    f.write(json.dumps(group_data, indent=4))

if is_svg2_only:
    out_path = 'site/images/chart-svg2_w3c.svg'
else:
    out_path = 'site/images/chart_w3c.svg'

try:
    subprocess.check_call(['./barh', 'chart_w3c.json', out_path])
